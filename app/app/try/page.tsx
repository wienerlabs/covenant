...
export default function TryItPage() {
  ...
  const boxStyle = (active: boolean, pass: boolean): React.CSSProperties => ({
    ...
    fontSize: "10px",
    color: active ? (pass ? "#fffeb2" : "#fca5a5") : "rgba(255,255,255,0.5)",
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "40px 24px" }}>
              ...
              <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px", marginTop: "16px" }}>
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontSize: "28px", fontWeight: 700, color: wordCountPasses ? "#fffeb2" : "#ffffff" }}>
                      {wordCount}
                    </div>
                ...
                <div style={{ marginTop: "12px" }}>
                  <div style={{
                    ...
                    <div style={{
                      ...
                      height: "100%",
                      borderRadius: "3px",
                      backgroundColor: progress >= 100 ? "#fffeb2" : "#fffeb2",
                      transition: "width 0.3s ease, background-color 0.3s ease",
                    }} />
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", marginTop: "4px" }}>
                    <span style={{ fontSize: "9px", color: "rgba(255,255,255,0.3)" }}>0</span>
                    <span style={{ fontSize: "9px", color: progress >= 100 ? "#fffeb2" : "rgba(255,255,255,0.3)" }}>
                      {Math.round(progress)}%
                    </span>
                  ...
                  >
                    <div style={{ textAlign: "center", marginBottom: "12px" }}>
                      <div style={{
                        fontSize: "24px",
                        fontWeight: 700,
                        color: result.passed ? "#fffeb2" : "#fca5a5",
                      }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", fontSize: "10px" }}>
                        ...
                        <span style={{ color: result.passed ? "#fffeb2" : "#fca5a5" }}>{result.passed ? "Yes" : "No"}</span>
                      </div>
                    </div>
                  </div>
                )}
          ...
          <div style={{ textAlign: "center", paddingBottom: "40px" }}>
            <Link
              ...
              onMouseLeave={(e) => { e.currentTarget.style.color = "#fffeb2"; }}
            >
