...
function typeBadgeColor(type: string): { bg: string; border: string; text: string } {
  ...
  if (type.includes("accept")) return { bg: "rgba(253,230,138,0.15)", border: "rgba(253,230,138,0.3)", text: "#fffeb2" };
  if (type.includes("submit") || type === "submission") return { bg: "rgba(16,185,129,0.15)", border: "rgba(16,185,129,0.3)", text: "#fffeb2" };
