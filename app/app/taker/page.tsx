...
export default function TakerPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: "inherit", position: "relative" }}>
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 0, backgroundImage: "image-set(url('/poster-bg.webp') type('image/webp'), url('/poster-bg.png') type('image/png'))", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }} />
