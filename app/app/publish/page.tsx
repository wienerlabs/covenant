              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                    ...
                    {["LLM", "Task", "Execution"].map((t) => (
                      <label
                        ...
                        style={{
                          ...
                          padding: "8px 14px",
                          borderRadius: "6px",
                          border: `1px solid ${agentType === t ? "#fffeb2" : "rgba(255,255,255,0.15)"}`,
                          backgroundColor: agentType === t ? "rgba(59,130,246,0.15)" : "transparent",
                          fontSize: "12px",
                          color: agentType === t ? "#fffeb2" : "rgba(255,255,255,0.5)",
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "8px",
                    backgroundColor: loading ? "rgba(59,130,246,0.2)" : "#fffeb2",
                    color: loading ? "#fffeb2" : "#ffffff",
                ...
                {result && (
                  <div style={{ fontSize: "12px", color: "#fffeb2", padding: "12px", borderRadius: "8px", backgroundColor: "rgba(134,239,172,0.1)" }}>
