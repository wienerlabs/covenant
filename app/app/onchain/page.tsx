              ...
              <div style={glassCard}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                  ...
                  <div>
                    ...
                    <div style={{ ...valueStyle, color: data.program.executable ? "#fffeb2" : "rgba(255,255,255,0.4)" }}>
              ...
              <div style={glassCard}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                  {([
                    ...
                    { label: "Agent Alpha", data: data.wallets.alpha, color: "#fffeb2", key: "alpha" as const },
                    { label: "Agent Omega", data: data.wallets.omega, color: "#fffeb2", key: "omega" as const },
                  ]).map((wallet) => {
